...
from model152 import resnet152
...
data_dir = r'D:\wzh_data2\2class_new\guju_dongmai'
...
def train_model(model, criterion, optimizer, scheduler, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            if epoch % 1 == 0:
                torch.save(model.state_dict(), "./models/res34_g_d_model-{}.pt".format(epoch))
...
if __name__ == '__main__':
    ...
    #model.load_state_dict(torch.load("D:/wzh_data2/2class_new/dongmai_xianwei/res101_d_x_model-196.pt"))
    model_ft = model

    #weights_path = "resnet101-5d3b4d8f (1).pth"
